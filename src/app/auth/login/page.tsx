      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        >
          <a href="/" className="inline-flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center font-bold text-black text-xl">
              CP
            </div>
        ...
        >
          ...
          <div className="my-6 flex items-center gap-4">
            ...
            <span className="text-white/20 text-xs uppercase tracking-wider">oppure</span>
            <div className="flex-1 h-px bg-white/10" />
          </div>
        ...
        <motion.p
          ...
          className="text-center text-white/20 text-xs mt-6 font-[family-name:var(--font-inter)]"
        >
          Accedendo accetti i{" "}
          <a href="/termini" className="text-white/40 hover:text-white/60 underline">
            Termini di Servizio
          </a>{" "}
          e la{" "}
          <a href="/privacy" className="text-white/40 hover:text-white/60 underline">
            Privacy Policy
          </a>
        </motion.p>
      </div>
